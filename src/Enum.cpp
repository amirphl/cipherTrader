...
std::string toString(Side side) { return (side == Side::BUY) ? "buy" : "sell"; }
...
Timeframe toTimeframe(const std::string &timeframe_str) {
  static const std::unordered_map<std::string, Timeframe> timeframe_map = {
      {"1m", Timeframe::MINUTE_1},   {"3m", Timeframe::MINUTE_3},
      {"5m", Timeframe::MINUTE_5},   {"15m", Timeframe::MINUTE_15},
      {"30m", Timeframe::MINUTE_30}, {"45m", Timeframe::MINUTE_45},
      {"1h", Timeframe::HOUR_1},     {"2h", Timeframe::HOUR_2},
      {"3h", Timeframe::HOUR_3},     {"4h", Timeframe::HOUR_4},
      {"6h", Timeframe::HOUR_6},     {"8h", Timeframe::HOUR_8},
      {"12h", Timeframe::HOUR_12},   {"1D", Timeframe::DAY_1},
      {"3D", Timeframe::DAY_3},      {"1W", Timeframe::WEEK_1},
