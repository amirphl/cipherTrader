...
const std::unordered_map< ct::enums::Exchange, std::unordered_map< std::string, ct::info::ExchangeInfo > >
    ct::info::EXCHANGE_INFO{
        {enums::Exchange::BYBIT_USDC_PERPETUAL,
         {
             {"name", toString(enums::Exchange::BYBIT_USDT_PERPETUAL)},
             {"url", CIPHER_TRADER_WEBSITE_URL + "/bybit"},
             {"fee", 0.00055},
             {"type", enums::ExchangeType::FUTURES},
             {"settlement_currency", "USDT"},
             {"supported_leverage_modes",
              std::vector< enums::LeverageMode >{enums::LeverageMode::CROSS, enums::LeverageMode::ISOLATED}},
        ...
        {enums::Exchange::BYBIT_USDT_PERPETUAL_TESTNET,
         {
             {"name", toString(enums::Exchange::BYBIT_USDT_PERPETUAL_TESTNET)},
             {"url", CIPHER_TRADER_WEBSITE_URL + "/bybit"},
             {"fee", 0.00055},
             {"type", enums::ExchangeType::FUTURES},
             {"settlement_currency", "USDT"},
        ...
        {enums::Exchange::BYBIT_USDC_PERPETUAL,
         {
             {"name", toString(enums::Exchange::BYBIT_USDC_PERPETUAL)},
             {"url", CIPHER_TRADER_WEBSITE_URL + "/bybit"},
             {"fee", 0.00055},
             {"type", enums::ExchangeType::FUTURES},
        ...
        {enums::Exchange::BYBIT_USDC_PERPETUAL_TESTNET,
         {
             {"name", toString(enums::Exchange::BYBIT_USDC_PERPETUAL_TESTNET)},
             {"url", CIPHER_TRADER_WEBSITE_URL + "/bybit"},
             {"fee", 0.00055},
             {"type", enums::ExchangeType::FUTURES},
             {"supported_leverage_modes",
        ...
        {enums::Exchange::BYBIT_SPOT,
         {
             {"name", toString(enums::Exchange::BYBIT_SPOT)},
             {"url", CIPHER_TRADER_WEBSITE_URL + "/bybit"},
             {"fee", 0.001},
             {"type", enums::ExchangeType::SPOT},
             {"supported_leverage_modes",
              std::vector< enums::LeverageMode >{enums::LeverageMode::CROSS, enums::LeverageMode::ISOLATED}},
             {"supported_timeframes", BYBIT_TIMEFRAMES},
             {"modes", std::unordered_map< std::string, bool >{{"backtesting", true}, {"live_trading", true}}},
        ...
        {enums::Exchange::BYBIT_SPOT_TESTNET,
         {
             {"name", toString(enums::Exchange::BYBIT_SPOT_TESTNET)},
             {"url", CIPHER_TRADER_WEBSITE_URL + "/bybit"},
             {"fee", 0.001},
             {"type", enums::ExchangeType::SPOT},
             {"supported_leverage_modes",
        ...
        {enums::Exchange::BITFINEX_SPOT,
         {
             {"name", toString(enums::Exchange::BITFINEX_SPOT)},
             {"url", "https://bitfinex.com"},
             {"fee", 0.002},
             {"type", enums::ExchangeType::SPOT},
             {"supported_leverage_modes", std::vector< enums::LeverageMode >{enums::LeverageMode::CROSS}},
        ...
        {enums::Exchange::BINANCE_SPOT,
         {
             {"name", toString(enums::Exchange::BINANCE_SPOT)},
        ...
        {enums::Exchange::BINANCE_US_SPOT,
         {
             {"name", toString(enums::Exchange::BINANCE_US_SPOT)},
        ...
        {enums::Exchange::BINANCE_PERPETUAL_FUTURES,
         {
             {"name", toString(enums::Exchange::BINANCE_PERPETUAL_FUTURES)},
             {"url", "https://binance.com"},
             {"fee", 0.0004},
             {"type", enums::ExchangeType::FUTURES},
             {"supported_leverage_modes",
        ...
        {enums::Exchange::BINANCE_PERPETUAL_FUTURES_TESTNET,
         {
             {"name", toString(enums::Exchange::BINANCE_PERPETUAL_FUTURES_TESTNET)},
             {"url", "https://binance.com"},
             {"fee", 0.0004},
             {"type", enums::ExchangeType::FUTURES},
             {"supported_leverage_modes",
        ...
        {enums::Exchange::COINBASE_SPOT,
         {
             {"name", toString(enums::Exchange::COINBASE_SPOT)},
        ...
        {enums::Exchange::APEX_PRO_PERPETUAL_TESTNET,
         {
             {"name", toString(enums::Exchange::APEX_PRO_PERPETUAL_TESTNET)},
        ...
        {enums::Exchange::APEX_PRO_PERPETUAL,
         {
             {"name", toString(enums::Exchange::APEX_PRO_PERPETUAL)},
        ...
        {enums::Exchange::APEX_OMNI_PERPETUAL_TESTNET,
         {
             {"name", toString(enums::Exchange::APEX_OMNI_PERPETUAL_TESTNET)},
        ...
        {enums::Exchange::APEX_OMNI_PERPETUAL,
         {
             {"name", toString(enums::Exchange::APEX_OMNI_PERPETUAL)},
        ...
        {enums::Exchange::GATE_USDT_PERPETUAL,
         {
             {"name", toString(enums::Exchange::GATE_USDT_PERPETUAL)},
        ...
        {enums::Exchange::GATE_SPOT,
         {
             {"name", toString(enums::Exchange::GATE_SPOT)},
             {"url", "https://jesse.trade/gate"},
             {"fee", 0.0005},
             {"type", enums::ExchangeType::SPOT},
             {"supported_leverage_modes",
        ...
        {enums::Exchange::FTX_PERPETUAL_FUTURES,
         {
             {"name", toString(enums::Exchange::FTX_PERPETUAL_FUTURES)},
        ...
        {enums::Exchange::FTX_SPOT,
         {
             {"name", toString(enums::Exchange::FTX_SPOT)},
        ...
        {enums::Exchange::FTX_US_SPOT,
         {
             {"name", toString(enums::Exchange::FTX_US_SPOT)},
             {"url", "https://ftx.us"},
             {"fee", 0.002},
             {"type", enums::ExchangeType::SPOT},
             {"supported_leverage_modes", std::vector< enums::LeverageMode >{enums::LeverageMode::CROSS}},
        ...
        {enums::Exchange::BITGET_USDT_PERPETUAL_TESTNET,
         {
             {"name", toString(enums::Exchange::BITGET_USDT_PERPETUAL_TESTNET)},
        ...
        {enums::Exchange::BITGET_USDT_PERPETUAL,
         {
             {"name", toString(enums::Exchange::BITGET_USDT_PERPETUAL)},
             {"url", CIPHER_TRADER_WEBSITE_URL + "/bitget"},
             {"fee", 0.0006},
             {"type", enums::ExchangeType::FUTURES},
             {"supported_leverage_modes",
        ...
        {enums::Exchange::BITGET_SPOT,
         {
             {"name", toString(enums::Exchange::BITGET_SPOT)},
             {"url", CIPHER_TRADER_WEBSITE_URL + "/bitget"},
             {"fee", 0.0006},
             {"type", enums::ExchangeType::SPOT},
             {"supported_leverage_modes",
        ...
        {enums::Exchange::DYDX_PERPETUAL,
         {
             {"name", toString(enums::Exchange::DYDX_PERPETUAL)},
        ...
        {enums::Exchange::DYDX_PERPETUAL_TESTNET,
         {
             {"name", toString(enums::Exchange::DYDX_PERPETUAL_TESTNET)},
